...
const ErrorComponent: React.FC<ErrorComponentProps> = ({ message, visible, dismissError }) => {
    ...
    return (
        <div className="error-component">
            ...
            <span>{message}</span>
            {/* Add a dismiss button to hide the error message, it calls the dismissError function when clicked */}
            <button onClick={dismissError}><b>X</b></button>
        </div>
    );
};
